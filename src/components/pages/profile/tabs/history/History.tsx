...
export const GameHistory = () => {
	const { data, loading } = useGetMyHistoryQuery()
							...
							return (
								...
								>
									...
									>
										...
										{/* Right: arrow */}
										<svg
											className='h-4 w-4 shrink-0 text-white/15 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-white/30'
											fill='none'
											viewBox='0 0 16 16'
										>
											<path
