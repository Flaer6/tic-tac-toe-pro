				...
				<div className='overflow-hidden bg-card'>
					...
					<div className='border-t border-white/10 bg-black/10'>
						<div className='relative'>
							{/* LEFT FADE */}
							<div className='pointer-events-none absolute left-0 top-0 z-10 h-full w-8 bg-gradient-to-r from-black/40 to-transparent md:hidden' />

							{/* RIGHT FADE */}
							<div className='pointer-events-none absolute right-0 top-0 z-10 h-full w-8 bg-gradient-to-l from-black/40 to-transparent md:hidden' />
